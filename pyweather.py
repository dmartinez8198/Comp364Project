...
def derive_nth_day_feature(df, feature, N):
    ...
    #For loop creates columns from features rather than having the feature columns be created individually
...
#code profiling, reduced amount of dataframes being created 
